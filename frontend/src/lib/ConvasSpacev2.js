   ...
   useEffect(() => {
      ...
      class Star extends PIXI.Graphics {
         ...
         initialize(x, y) {
            ...
            this.fadeDelay = Math.floor(seededRandom(Date.now()) * this.fadeDelayMax)
      ...
      class Comet extends Star {
         ...
         update() {
            ...
            for (let i = 1; i < this.positions.length; i++) {
               ...
               const distance = Math.sqrt((currentPosition.x - previousPosition.x) ** 2 + (currentPosition.y - previousPosition.y) ** 2)
               ...
               if (distance < 100) {
                  ...
                  this.trail.moveTo(previousPosition.x, previousPosition.y)
            ...
            if (
               ...
               const respawnDelay = Math.random() * (maxRespawnDelay - minRespawnDelay) + minRespawnDelay
